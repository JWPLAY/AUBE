namespace JW.AUBE.Core.Forms.Auth
{
	partial class CalendarForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.lcItemCalDate = new DevExpress.XtraLayout.LayoutControlItem();
			this.datCalDate = new DevExpress.XtraEditors.DateEdit();
			this.lcItemHolidayYn = new DevExpress.XtraLayout.LayoutControlItem();
			this.chkHolidayYn = new DevExpress.XtraEditors.CheckEdit();
			...
			((System.ComponentModel.ISupportInitialize)(this.lcItemCalYear)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.lcItemCalDate)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.datCalDate.Properties.CalendarTimeProperties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.datCalDate.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.lcItemHolidayYn)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.chkHolidayYn.Properties)).BeginInit();
			...
			// lc
			// 
			this.lc.Controls.Add(this.btnCreate);
			this.lc.Controls.Add(this.datCalYear);
			this.lc.Controls.Add(this.chkHolidayYn);
			this.lc.Controls.Add(this.datCalDate);
			...
			// datCalYear
			// 
			this.datCalYear.EditValue = null;
			this.datCalYear.Location = new System.Drawing.Point(133, 18);
			this.datCalYear.Name = "datCalYear";
			this.datCalYear.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.datCalYear.Properties.CalendarTimeProperties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.datCalYear.Size = new System.Drawing.Size(131, 20);
			this.datCalYear.StyleController = this.lc;
			this.datCalYear.TabIndex = 20;
			// 
			// emptySpaceItem4
			// 
            ...
            this.lcItemRemarks,
            this.lcItemCalDate,
            this.lcItemHolidayYn,
            this.emptySpaceItem2});
			this.lcGroupEdit.Location = new System.Drawing.Point(574, 0);
			this.lcGroupEdit.Name = "lcGroupEdit";
			this.lcGroupEdit.Padding = new DevExpress.XtraLayout.Utils.Padding(4, 4, 4, 4);
			this.lcGroupEdit.Size = new System.Drawing.Size(450, 185);
			this.lcGroupEdit.TextVisible = false;
			// 
			// lcItemHolidayName
			// 
			this.lcItemHolidayName.Control = this.txtHolidayName;
			this.lcItemHolidayName.Location = new System.Drawing.Point(0, 47);
			this.lcItemHolidayName.Name = "lcItemHolidayName";
			this.lcItemHolidayName.Size = new System.Drawing.Size(282, 24);
			this.lcItemHolidayName.TextSize = new System.Drawing.Size(111, 14);
			// 
			// txtHolidayName
			// 
			this.txtHolidayName.Location = new System.Drawing.Point(700, 58);
			this.txtHolidayName.Name = "txtHolidayName";
			this.txtHolidayName.Size = new System.Drawing.Size(163, 20);
			...
			this.emptySpaceItem3.Location = new System.Drawing.Point(282, 47);
			...
			this.lcItemRemarks.Location = new System.Drawing.Point(0, 71);
			this.lcItemRemarks.MaxSize = new System.Drawing.Size(436, 100);
			this.lcItemRemarks.MinSize = new System.Drawing.Size(436, 100);
			this.lcItemRemarks.Name = "lcItemRemarks";
			this.lcItemRemarks.Size = new System.Drawing.Size(436, 100);
			...
			// memRemarks
			// 
			this.memRemarks.Location = new System.Drawing.Point(700, 82);
			this.memRemarks.Name = "memRemarks";
			this.memRemarks.Size = new System.Drawing.Size(317, 96);
			this.memRemarks.StyleController = this.lc;
			this.memRemarks.TabIndex = 14;
			// 
			// lcItemCalDate
			// 
			this.lcItemCalDate.Control = this.datCalDate;
			this.lcItemCalDate.Location = new System.Drawing.Point(0, 0);
			this.lcItemCalDate.Name = "lcItemCalDate";
			this.lcItemCalDate.Size = new System.Drawing.Size(282, 24);
			this.lcItemCalDate.TextSize = new System.Drawing.Size(111, 14);
			// 
			// datCalDate
			// 
			this.datCalDate.EditValue = null;
			this.datCalDate.Location = new System.Drawing.Point(700, 11);
			this.datCalDate.Name = "datCalDate";
			this.datCalDate.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.datCalDate.Properties.CalendarTimeProperties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.datCalDate.Size = new System.Drawing.Size(163, 20);
			this.datCalDate.StyleController = this.lc;
			this.datCalDate.TabIndex = 18;
			// 
			// lcItemHolidayYn
			// 
			this.lcItemHolidayYn.Control = this.chkHolidayYn;
			this.lcItemHolidayYn.Location = new System.Drawing.Point(0, 24);
			this.lcItemHolidayYn.Name = "lcItemHolidayYn";
			this.lcItemHolidayYn.Size = new System.Drawing.Size(282, 23);
			this.lcItemHolidayYn.TextSize = new System.Drawing.Size(111, 14);
			// 
			// chkHolidayYn
			// 
			this.chkHolidayYn.Location = new System.Drawing.Point(700, 35);
			this.chkHolidayYn.Name = "chkHolidayYn";
			this.chkHolidayYn.Properties.Caption = "";
			this.chkHolidayYn.Size = new System.Drawing.Size(163, 19);
			this.chkHolidayYn.StyleController = this.lc;
			this.chkHolidayYn.TabIndex = 19;
			// 
			// emptySpaceItem2
			// 
			this.emptySpaceItem2.AllowHotTrack = false;
			this.emptySpaceItem2.Location = new System.Drawing.Point(282, 24);
			this.emptySpaceItem2.Name = "emptySpaceItem2";
			this.emptySpaceItem2.Size = new System.Drawing.Size(154, 23);
			...
			((System.ComponentModel.ISupportInitialize)(this.lcItemCalYear)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.lcItemCalDate)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.datCalDate.Properties.CalendarTimeProperties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.datCalDate.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.lcItemHolidayYn)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.chkHolidayYn.Properties)).EndInit();
		...
		private DevExpress.XtraEditors.DateEdit datCalDate;
		private DevExpress.XtraLayout.LayoutControlItem lcItemCalDate;
		private DevExpress.XtraEditors.CheckEdit chkHolidayYn;
		private DevExpress.XtraLayout.LayoutControlItem lcItemHolidayYn;
		private DevExpress.XtraLayout.EmptySpaceItem emptySpaceItem2;
		private DevExpress.XtraEditors.DateEdit datCalYear;
		private DevExpress.XtraLayout.LayoutControlItem lcItemCalYear;
