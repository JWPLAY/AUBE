	...
	public partial class CostListForm : EditForm
	{
		...
		void InitGrid()
		{
			...
			gridList.AddGridColumns(
				...
				new XGridColumn() { FieldName = "BASE_QTY", HorzAlignment = HorzAlignment.Far, Width = 90, FormatType = FormatType.Numeric, FormatString = "N0" },
				new XGridColumn() { FieldName = "BASE_AMT", HorzAlignment = HorzAlignment.Far, Width = 110, FormatType = FormatType.Numeric, FormatString = "N0" },
				new XGridColumn() { FieldName = "PURC_QTY", HorzAlignment = HorzAlignment.Far, Width = 90, FormatType = FormatType.Numeric, FormatString = "N0" },
				new XGridColumn() { FieldName = "PURC_AMT", HorzAlignment = HorzAlignment.Far, Width = 110, FormatType = FormatType.Numeric, FormatString = "N0" },
				new XGridColumn() { FieldName = "TSUM_QTY", HorzAlignment = HorzAlignment.Far, Width = 90, FormatType = FormatType.Numeric, FormatString = "N0" },
				new XGridColumn() { FieldName = "TSUM_AMT", HorzAlignment = HorzAlignment.Far, Width = 110, FormatType = FormatType.Numeric, FormatString = "N0" },
			...
			gridList.SetColumnBackColor(Color.LightYellow, "COST_PRICE");
